 ...
 */
public interface CrudHooks<E extends Persistable<@NonNull ID>, D, ID> extends ReadHooks<E, ID>, WriteHooks<E, D, ID> {
    ...
    static <E extends Persistable<@NonNull ID>, D, ID> CrudHooks<E, D, ID> getDefault() {
