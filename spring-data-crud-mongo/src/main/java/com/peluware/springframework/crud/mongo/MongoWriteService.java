 ...
 */
public interface MongoWriteService<E extends Persistable<@NonNull ID>, D, ID, R extends MongoRepository<@NonNull E, @NonNull ID>> extends StandardWriteService<E, D, ID, R> {
}